<footer>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="about-veno">
                        <div class="logo">
                            <a href="index.html">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/footer_logo.png" alt="Venue Logo">
                            </a>
                        </div>
    ...
    <div class="sub-footer">
    	...
    	- Design: <a rel="nofollow" href="<?php echo get_template_directory_uri();?>/assets/http://www.templatemo.com">Template Mo</a></p>
    </div>

    <script src="<?php echo get_template_directory_uri();?>/assets/https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js" type="text/javascript"></script>
